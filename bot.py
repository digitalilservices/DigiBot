...
async def main():
    ...
    premium = await PremiumEmoji.from_sticker_sets(
        bot,
        ["sohccw_by_EmojiTitleBot", "sog5ed_by_EmojiTitleBot", "sy1gu7_by_EmojiTitleBot", "sepu9i_by_EmojiTitleBot", "sfxbpi_by_EmojiTitleBot", "s0rve8_by_EmojiTitleBot", "sl63qq_by_EmojiTitleBot"]
    )
    dp["premium"] = premium
