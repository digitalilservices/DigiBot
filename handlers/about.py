...
ABOUT_PAGE_1 = (
    ...
    "🚀 <b>DigaroBot</b> — это рекламная платформа, и инструмент для заработка <b>USDT</b> с единым балансом.\n\n"
    ...
    "Вы можете бесплатно пользоваться сервисом и зарабатывать <b>USDT.</b>\n\n"
...
ABOUT_PAGE_2 = (
    ...
    "• Выводить <b>USDT</b>\n"
    "• Конвертировать <b>USDT ↔️ DGR и DGR ↔️ USDT</b>\n\n"
