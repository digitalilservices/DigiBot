...
# ===== СТРАНИЦЫ ABOUT =====
ABOUT_PAGE_1 = (
    "ℹ️ <b>Экосистема DigaroBot</b>\n\n"
    "🤖 <b>Что такое DigaroBot</b> ❓\n\n"
    "🚀 <b>DigaroBot</b> — это рекламная платформа, экосистема сервисов и инструмент для заработка <b>USDT</b> с единым балансом.\n\n"
    "📢 <b>Рекламная платформа</b>\n"
    "Создавайте задания и продвигайте каналы, группы, ботов, посты, а также TikTok, YouTube, Instagram, Telegram и сайты внутри системы. 🚀\n\n"
    "💵 <b>Заработок USDT</b>\n"
    "<b>4 USDT</b> за каждого реферала <b>+ 2 USDT</b>, если ваш реферал пригласит ещё одного пользователя.\n"
    "Со статусом <b>«Лидер»</b> вы получите конвертацию <b>DGR в USDT.</b>\n\n"
    "🪙 <b>Валюта DGR</b>\n"
    "Зарабатывайте DGR, выполняя задания.\n\n"
    "🔄 <b>Конвертация</b>\n"
    "<b>5000 DGR = 1 USDT</b>\n"
    "<b>1 USDT = 5000 DGR</b>\n\n"
    ...
    "🪙 <b>DigaroBot — простой и эффективный инструмент.\n"
    "Вы можете бесплатно пользоваться сервисом и зарабатывать <b>USDT.</b> Чтобы активировать статус <b>«Активный»</b>, достаточно пригласить <b>3</b> рефералов и заработать <b>10 USDT</b> для активации.\n\n"
    "👨‍💻 <b>Администратор:</b> @illy228\n\n"
    "⚠️ <b>Больше информации жми</b> «▶️»"
)

ABOUT_PAGE_2 = (
    "❓ <b>Как пользоваться DigaroBot</b>\n\n"
    "💸 <b>Раздел «Заработать»</b>\n"
    "Выполняйте задания других пользователей и получайте монеты <b>DGR</b> на баланс. Также вы можете создавать собственные задания и продвигать свои проекты.\n\n"
    "🚀 <b>Раздел «Продвижение»</b>\n"
    "Продвигайте TikTok, Instagram, YouTube, Telegram и сайты внутри системы.\n\n"
    "👥 <b>Раздел «Реферал»</b>\n"
...
# ===== ПЕРВАЯ СТРАНИЦА =====
@router.message(F.text == "ℹ️ О экосистеме DigaroBot")
...
async def go_service(call: CallbackQuery, premium: PremiumEmoji):
    ...
    text = (
        ...
        "Далее потребуется активировать статус «Активный» в DigaroBot "
