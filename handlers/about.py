...
async def about(message: Message, cfg: Config, premium: PremiumEmoji):
    ...
    text = (
        ...
        "💵 <b>Заработок USDT</b>\n"
        "<b>4 USDT</b> за каждого реферала <b>+ 2 USDT</b>, если ваш реферал пригласит ещё одного пользователя. Со статусом <b>«Лидер»</b> доступна конвертация <b>DIGI в USDT.</b>\n\n"
