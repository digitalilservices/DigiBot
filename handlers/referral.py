...
async def referral(message: Message, cfg: Config, db: Database, premium: PremiumEmoji):
    ...
    if status not in ("active", "leader"):
        text = (
            ...
            "👑 <b>Для статуса «Лидер»:</b>\n"
            "• Нужно <b>10 рефералов</b>\n"
            "• Каждый должен пополнить <b>от 10 USDT</b>"
        )
    ...
    text = (
        ...
        "📌 Реферал засчитывается, когда приглашённый пополнит <b>5 USDT</b>\n"
        "👑 Для статуса «Лидер»: нужно <b>10 рефералов</b> с пополнением <b>от 10 USDT</b>\n\n"
